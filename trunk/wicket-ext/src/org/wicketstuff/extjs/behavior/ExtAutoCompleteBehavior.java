...
import org.wicketstuff.extjs.ExtAjax;
...
public abstract class ExtAutoCompleteBehavior extends ExtFormComponentBehavior {
	...
	private static final String ON_SELECT_DEFAULT = 
			...
			"if (v != this.getValue()){ this.fireEvent('change', this, this.getValue(), v); } "+
			"}; ";

	private IExtDataSource data;
	...
	public IExtDataSource getData() {
		return data;
	}
	
	public void setData(IExtDataSource data) {
		this.data = data;
	}
